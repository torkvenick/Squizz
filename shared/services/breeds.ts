...
export const Breeds: Breed[] = [
  {
    ...
    dogs: [
      "keesduitse staande langhaar hond",
      "keeshond",
      "lhasa apso",
  ...
  {
    dog: "keesduitse staande langhaar hond",
    imgs: [
